...
class Move:
	...
	def __init__(self, piece, row2, col2, row1 = None, col1 = None, capture = None, check = False, promote = None, en_passant = False, castling = None):
		# Assertions
		...
		assert not castling or (piece == KING and row1 in (0,7) and row1 == row2 and col1 == 4 and col2 in (2, 6) and castling in (KING, QUEEN))
		# Assignments
		self.piece = piece
		self.row2 = row2
		self.col2 = col2
